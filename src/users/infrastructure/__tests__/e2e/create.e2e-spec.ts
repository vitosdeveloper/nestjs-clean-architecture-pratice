...
describe('create e2e', () => {
  ...
  describe('POST /users', () => {
    ...
    it('should return a error with 422 code when the name field isnt valid', async () => {
    ...
    it('should return a error with 422 code when the email field isnt valid', async () => {
    ...
    it('should return a error with 422 code when the password field isnt valid', async () => {
    ...
    it('should return a error with 409 code when the email is duplciated', async () => {
      ...
      expect(res.body.error).toBe('Conflifct');
